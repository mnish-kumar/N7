...
const DigitalBankingSection = () => {
  return (
    <section className="relative py-16 md:py-24 bg-[#E8EEF2] text-[#000D12] overflow-hidden px-6 sm:px-10 md:px-16">
      <h1
  ...
  [-webkit-text-stroke:2px_#00B4FD]
  text-transparent"
      >
        N7
      </h1>
      ...
      <div className="relative w-full z-10 max-w-[1200px] mx-auto flex flex-col md:flex-row md:justify-between gap-10 md:gap-0">
        ...
        <div className="flex flex-col w-full md:w-1/3 md:flex-row justify-between items-start mb-16 md:mb-24 gap-8">
          <div className="w-full md:max-w-[420px]">
            ...
            <p className="mt-4 md:mt-5 text-sm text-black/70 max-w-[320px]">
            ...
            <div className="flex items-center gap-6 mt-6 md:mt-8">
              <ButtonRequestDemo />
              <button
                className="flex items-center gap-2 text-[#0057FF] text-xs font-chivo
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="w-full md:w-1/2 max-w-full md:max-w-[380px]">
                ...
                <p className="text-sm text-black/60 leading-6 mb-6 md:mb-8">
                  {feature.description}
                </p>
                <div className="flex flex-col gap-4 md:gap-5">
                  {feature.points.map((point) => (
                    <div key={point} className="flex items-start gap-3">
                      ...
                      />
                      <p className="text-sm text-black/75 leading-6">{point}</p>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <div className="bg-[#000D12] rounded-2xl mt-20">
        <PaperlessSection />
      </div>
